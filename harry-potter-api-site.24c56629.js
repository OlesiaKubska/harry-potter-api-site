document.addEventListener("DOMContentLoaded",()=>{console.log("\uD83E\uDDD9‍♂️ Welcome to the Harry Potter!");let t=document.querySelector(".hero__btn"),e=document.getElementById("characters"),r=document.querySelector(".characters-cards"),a=document.querySelectorAll(".characters__btn"),s=document.querySelector(".characters-filters"),n=s.querySelectorAll(".characters-filters__btn"),c=document.getElementById("characters-title"),o=document.getElementById("character-modal"),d=document.getElementById("modal-body"),i=document.querySelector(".modal__content"),l=async()=>{try{let t=await fetch("https://hp-api.onrender.com/api/characters");return await t.json()}catch(t){return console.error("Error fetching characters:",t),[]}},h=async t=>{try{let e=await fetch(`https://hp-api.onrender.com/api/characters/house/${t}`);return await e.json()}catch(e){return console.error(`Error fetching characters for ${t}:`,e),[]}},u=t=>{c.textContent=({students:"Студенти Гоґвортсу",staff:"Співробітники Гоґвортсу",house:"Персонажі в певному будинку"})[t]||"",c.classList.remove("visually-hidden")},g=t=>{r.innerHTML="",t.forEach(t=>{let e=document.createElement("div");e.classList.add("characters-cards__card"),e.innerHTML=`
